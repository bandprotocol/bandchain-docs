...
Please note that the seed is a generated string on the consumer side.
Any two different consumers may be using the same seed. However, every consumer must use a unique seed for all their requests, as the VRFProvider has a mapping to check this condition.
...
To request the VRF randomness on Bandchain, we need to know the `oracleScriptID`. The VRF data script is the ID [**335**](https://laozi-testnet6.cosmoscan.io/oracle-script/335) on the laozi-Testnet6.
...
<iframe
  width="100%"
  height="500"
  src="https://www.youtube.com/embed/PjjcEFqxRAY?si=_f4mso8oti6T8aGa"
  title="Manual request and resolve method"
  frameborder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowfullscreen
></iframe>

**Recommended Data Script Request Settings**
