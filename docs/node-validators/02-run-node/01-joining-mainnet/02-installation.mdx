...
```bash
cd ~
# Clone BandChain Laozi version v3.1.2
git clone https://github.com/bandprotocol/chain
cd chain
git fetch && git checkout v3.1.2
...
| `v3_1`       | `42450000`     | [link](https://www.cosmoscan.io/proposal/15)                                | `1.24.2`   | `v3.1.2`      | `~/.band/cosmovisor/upgrades/v3_1/bin` |
...
TRUST_HEIGHT=$(($LATEST_HEIGHT-120000))
