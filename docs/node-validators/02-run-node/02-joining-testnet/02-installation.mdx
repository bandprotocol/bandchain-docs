...
```bash
cd ~
# Clone BandChain Laozi version v2.5.3
git clone https://github.com/bandprotocol/chain
cd chain
git fetch && git checkout v2.5.3
...
| `v2_5`       | `5557800`      | [link](https://laozi-testnet6.cosmoscan.io/proposal/6)                      | `1.19.1`   | `v2.5.3`      | `~/.band/cosmovisor/upgrades/v2_5/bin` |
